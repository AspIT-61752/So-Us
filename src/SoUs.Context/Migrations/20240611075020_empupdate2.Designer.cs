...
namespace SoUs.DataAccess.Migrations
{
    ...
    [Migration("20240611075020_empupdate2")]
            ...
            modelBuilder.Entity("SoUs.Entity.Assignment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ResidentId = 1,
                            TimeEnd = new DateTime(2024, 6, 11, 10, 5, 19, 795, DateTimeKind.Local).AddTicks(5031),
                            TimeStart = new DateTime(2024, 6, 11, 9, 50, 19, 795, DateTimeKind.Local).AddTicks(4985)
                        },
                        new
                        {
                            AssignmentId = 2,
                            ...
                            ResidentId = 1,
                            TimeEnd = new DateTime(2024, 6, 11, 10, 20, 19, 795, DateTimeKind.Local).AddTicks(5054),
                            TimeStart = new DateTime(2024, 6, 11, 10, 5, 19, 795, DateTimeKind.Local).AddTicks(5052)
                        },
                        new
                        {
                            AssignmentId = 3,
                            ...
                            Name = "Give medicin",
                            ResidentId = 1,
                            TimeEnd = new DateTime(2024, 6, 11, 10, 30, 19, 795, DateTimeKind.Local).AddTicks(5115),
                            TimeStart = new DateTime(2024, 6, 11, 10, 20, 19, 795, DateTimeKind.Local).AddTicks(5113)
                        });
                });
