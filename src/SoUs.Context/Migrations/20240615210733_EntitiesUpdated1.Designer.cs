...
namespace SoUs.DataAccess.Migrations
{
    ...
    [Migration("20240615210733_EntitiesUpdated1")]
    partial class EntitiesUpdated1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SoUs.Entity.Assignment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ResidentId = 1,
                            TimeEnd = new DateTime(2024, 6, 15, 16, 22, 33, 518, DateTimeKind.Local).AddTicks(8998),
                            TimeStart = new DateTime(2024, 6, 15, 16, 7, 33, 518, DateTimeKind.Local).AddTicks(8950)
                        },
                        new
                        {
                            AssignmentId = 2,
                            ...
                            ResidentId = 1,
                            TimeEnd = new DateTime(2024, 6, 15, 16, 37, 33, 518, DateTimeKind.Local).AddTicks(9024),
                            TimeStart = new DateTime(2024, 6, 15, 16, 22, 33, 518, DateTimeKind.Local).AddTicks(9022)
                        },
                        new
                        {
                            AssignmentId = 3,
                            ...
                            Name = "Give medicin",
                            ResidentId = 1,
                            TimeEnd = new DateTime(2024, 6, 15, 16, 47, 33, 518, DateTimeKind.Local).AddTicks(9042),
                            TimeStart = new DateTime(2024, 6, 15, 16, 37, 33, 518, DateTimeKind.Local).AddTicks(9040)
                        });
                });
